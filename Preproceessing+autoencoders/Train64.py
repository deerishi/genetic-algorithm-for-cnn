...
Ytrain_file='/home/drishi/trainingLabel64_file.npy'
Xtest_file='/home/drishi/testData128_file.npy'
Ytest_file='/home/drishi/testLabel64_file.npy'
...
WhitenedData64='/home/drishi/projectFiles/NoDimReducedWhitenedData64.npy'
WhitenedTestData64='/home/drishi/projectFiles/NoDimReducedWhitenedTestData64.npy'
...
XwhiteTrain=np.load(WhitenedData64)
...
def train():
    ...
    nb_hidden_layers = [len(XwhiteTrain[0]),3800, 3000, 2800]
    ...
    op1=RMSprop(lr=0.001,rho=0.5,epsilon=1e-8)
